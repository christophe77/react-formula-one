...
import { addFormulaOneItem, setDriverStandings, setIsLoading } from '../../features/formulaOneSlice';
...
const useFormulaPage = () => {
  ...
  const setItems = async () => {
    ...
    const driverStandingsItem: FormulaOneItem = {
      id: 3,
      sectionTitle: 'Driver standings',
      title: ``,
      subTitle: ``,
      description: ``,
      DescriptionElement : DriverStandingsTable,
      headerImageUrl: getRandomPicture(),
